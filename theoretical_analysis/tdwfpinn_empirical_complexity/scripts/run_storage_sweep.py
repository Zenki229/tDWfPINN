...
from tdw_verify.measure import measure_graph_storage
from tdw_verify.sweep import run_pair_sweep


def main() -> None:
    p = argparse.ArgumentParser(description="Measure retained graph storage for generalized GJ-I vs GJ-II.")
    p.add_argument("--device", type=str, default="cuda" if torch.cuda.is_available() else "cpu")
    p.add_argument("--out-csv", type=str, default="outputs/storage_sweep.csv")
    ...
    run_pair_sweep(
        measure_fn=measure_graph_storage,
        baseline=baseline,
